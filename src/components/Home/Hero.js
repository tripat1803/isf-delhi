...
export default function Hero() {
  return (
    <div id='home' className='flex flex-col min-h-[100vh] relative'>
      ...
      <div className='z-[13] bg-black py-12 px-4 ss:px-8 sm:px-16 text-white w-full flex-1 flex flex-col gap-8 justify-center items-center bg-opacity-70 relative'>
